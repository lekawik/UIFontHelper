...
extension UIFont {
    ...
    static var title: UIFont { return UIFont.preferredFont(forTextStyle: .title1) }
    ...
    static var caption: UIFont { return UIFont.preferredFont(forTextStyle: .caption1) }
    ...
    static func system(size: CGFloat, weight: UIFont.Weight = .regular, design: UIFontDescriptor.SystemDesign = .default) -> UIFont {
    ...
    static func custom(_ name: String, fixedSize: CGFloat) -> UIFont {
    ...
    static func custom(_ name: String, size: CGFloat, relativeTo: UIFont.TextStyle) -> UIFont {
